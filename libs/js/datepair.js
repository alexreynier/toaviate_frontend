...
(function(window, document) {
	...
	function Datepair(container, options) {
		...
		this._defaults =	{
			...
			parseTime: function(input){
				// console.log("PARSE TIME ",$(input).val());
				// console.log("PARSE TIME", jq(input).timepicker('getTime'));
				// var a = new Date();
				// a.setHour("")
				return jq(input).timepicker('getTime');
			},
			updateTime: function(input, dateObj){
				//console.log("UPDATE TIME ",input);
				jq(input).timepicker('setTime', dateObj);
			},
			setMinTime: function(input, dateObj){
				console.log("MIN TIME ",input);
				console.log("MIN TIME 2 ",dateObj);
				jq(input).timepicker('option', 'minTime', dateObj);
				// jq(input).timepicker('option', 'minDateTime', dateObj);
			},
	
			// defaults for bootstrap datepicker; override when using other input widgets
			parseDate: function(input){
				// console.log("PARSE DATE ",input);
	...
	Datepair.prototype = {
		...
		{
			// console.log("HERE WE GET: ", key);
			if (typeof key == 'object') {
				// console.log("ON SETUP KEY", key);
		...
		_updateEndMintime: function(){
			...
			// commented code was the original code...
			// var baseTime = null;

			// console.log("_ONE_DAY", _ONE_DAY);
			// console.log("this.dateDelta", this.dateDelta);
			// console.log("this.timeDelta", this.timeDelta);
			// var b = this.dateDelta + this.timeDelta;
			// console.log("b", b);
			...
			var startDate = new Date(this.settings.parseDate(this.startDateInput));
			var startTime = new Date(this.settings.parseTime(this.startTimeInput));
			...
			console.log("start time time: ", startTime.getTime());

			console.log("start date input ",this.startDateInput);
			console.log("start date input ",startDate);
			console.log("start date input ",startDate.getTime());



			console.log("dateDelta ", startDate);
			console.log("timeDelta", this.timeDelta);


			var baseTime = null;

			if(this.settings.anchor == 'start'){
				//baseTime = startDate + this.timeDelta;
				baseTime = startDate.getTime();
			}

			console.log("PASSED IS: "+baseTime);
			console.log("PASSED IS DATE: "+new Date(baseTime));
